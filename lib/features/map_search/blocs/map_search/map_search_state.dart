...
class MapSearchState extends Equatable {
  ...
  final String? focusedFilterPropertyId;
  ...
  MapSearchState copyWith({
    ...
    Object? focusedFilterPropertyId = _unset,
    ...
    return MapSearchState(
      ...
      focusedFilterPropertyId: focusedFilterPropertyId == _unset
          ? this.focusedFilterPropertyId
          : focusedFilterPropertyId as String?,
