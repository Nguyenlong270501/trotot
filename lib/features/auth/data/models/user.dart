...
class UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(userId: $userId, userName: $userName, email: $email, phoneNumber: $phoneNumber, avatarUrl: $avatarUrl, authProvider: ${authProvider.toJson()}, role: ${role.toJson()}, status: ${status.toJson()}, fcmTokens: $fcmTokens, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
